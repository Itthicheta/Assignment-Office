...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-slate-700 bg-slate-900 px-4 py-2.5">
        <span className="text-lg font-bold text-indigo-400">📋 {t('appName')}</span>
