...
const dict = {
  ...
  tabCheck: { en: 'To Check', th: 'ต้องตรวจ' },
  tabTodo: { en: 'To Do', th: 'สิ่งที่ต้องทำ' },
  tabHistory: { en: 'History', th: 'ประวัติ' },
  range1w: { en: '1 week', th: '1 สัปดาห์' },
  range2w: { en: '2 weeks', th: '2 สัปดาห์' },
  range1m: { en: '1 month', th: '1 เดือน' },
  range3m: { en: '3 months', th: '3 เดือน' },
  noHistory: { en: 'No finished tasks in this period.', th: 'ไม่มีงานที่เสร็จในช่วงนี้' },
  nothingToCheck: { en: 'Nothing waiting for you. 🎉', th: 'ไม่มีอะไรรอคุณ 🎉' },
  searchPlaceholder: { en: 'Search tasks…', th: 'ค้นหางาน…' },
  noResults: { en: 'No results', th: 'ไม่พบผลลัพธ์' },
  logSection: { en: 'Log', th: 'ประวัติงาน' },
  changePassword: { en: 'Change password', th: 'เปลี่ยนรหัสผ่าน' },
  oldPassword: { en: 'Current password', th: 'รหัสผ่านเดิม' },
  passwordChanged: { en: 'Password changed ✓', th: 'เปลี่ยนรหัสผ่านแล้ว ✓' },
  wrongOldPassword: { en: 'Current password is incorrect', th: 'รหัสผ่านเดิมไม่ถูกต้อง' },
