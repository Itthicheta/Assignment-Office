...
const dict = {
  ...
  signUp: { en: 'Create account', th: 'สมัครสมาชิก' },
  email: { en: 'Email', th: 'อีเมล' },
  password: { en: 'Password', th: 'รหัสผ่าน' },
  fullName: { en: 'Full name', th: 'ชื่อ-นามสกุล' },
  noAccount: { en: "No account? Create one", th: 'ยังไม่มีบัญชี? สมัครที่นี่' },
  haveAccount: { en: 'Already have an account? Sign in', th: 'มีบัญชีแล้ว? เข้าสู่ระบบ' },
  checkEmail: { en: 'Check your email to confirm your account.', th: 'กรุณายืนยันบัญชีในอีเมลของคุณ' },
  authTagline: {
